    ...
    $.fn.countUp = function(options) {
        ...
        $that.each(function(i) {
            ...
            var clear = setInterval(function() {
                ...
                $t.text(new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(value));
                ...
                if (total_frame > o.duration) {
                    clearInterval(clear);
                    $t.text(new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(o.last));
